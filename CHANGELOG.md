...
- The native extension now loads on Ruby development builds: it exports the `ruby_abi_version` their ABI check requires.
- Match Ruby 4.1's updated `rb_data_type_t` layout when registering the native selector.
